...
from src.fastapi_users import models, schemas
from src.fastapi_users.authentication import AuthenticationBackend, Authenticator
from src.fastapi_users.jwt import SecretType
from src.fastapi_users.manager import UserManagerDependency
from src.fastapi_users.router import (
    get_auth_router,
    get_register_router,
